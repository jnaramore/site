...
role: Data Scientist and Biomedical Engineer
...
bio: My research interests include statistical modeling, biosignals, and machine learning.

# Social Networking
# Need to use another icon? Simply download the SVG icon to your `assets/media/icons/` folder.
profiles:
  - icon: at-symbol
    url: 'mailto:wnaramore6@gatech.edu'
    label: E-mail Me
  # - icon: brands/x
